    ...
    match cmd:
        ...
        case IndexAssetCmd():
            ...
            els[eid] = AssetLibraryEntryElem(
                ...
                depthMm=cmd.depth_mm,
                heightMm=cmd.height_mm,
                clearanceMm=cmd.clearance_mm,
                maintenanceZoneMm=cmd.maintenance_zone_mm,
                placementSupport=cmd.placement_support,
                ...
                exportMetadata=cmd.export_metadata,
