...
class CommitConceptSeedCmd(BaseModel):
    """CON-V3-02 — transitions a ConceptSeedElem from draft → committed. T9 can then consume it."""
    ...
    kernel_element_drafts: list[dict] | None = Field(
        default=None, alias="kernelElementDrafts"
    )
