...
| `unsupported_renderer_feature` | 5 |
...
| `detached_or_flying` | error | `geometry.wall_detached_endpoint` | `target-house-l1-landing-access-partition` | {"levelId":"hf-lvl-upper","isolatedEndpoints":["start","end"],"lengthMm":2200,"boundsMm":{"minX":5400,"minY":1000,"maxX":7600,"maxY":1000}} |
