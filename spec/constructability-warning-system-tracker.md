...
| CW-021 | done | Medium | User-facing constructability report missing. | `/api/models/{model_id}/constructability-report`, web report client helpers, summary formatter, and `ConstructabilityReportPanel` now provide a unified report surface with refresh, grouping, isolation, JSON export, and BCF export actions. | Unified report with refresh, grouping, isolation, export. |
