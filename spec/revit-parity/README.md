...
| ----- | ---------------------------------------------------- | -------------- | ------------- | -------------------------------------------------------------------------------------------------------------------- |
| F-003 | Project Browser                                      | UI & Nav       | 🟡            | Plan views, 3D/section/elevation/sheet/schedule groups, view templates, sites, links, and family type rows exist; family rows support right-click select/rename/duplicate; floor plans group by discipline/subdiscipline. Missing legends/groups subtree and phase grouping |
| F-004 | Properties Palette (context-sensitive)               | UI & Nav       | 🟡            | Right-rail inspector with editable instance fields and wall/floor/roof Edit Type buttons; missing full Revit type/instance palette separation and automatic tab context switch when a type is selected |
...
| F-012 | Visibility / Graphic Overrides (VV)                  | UI & Nav       | 🟡            | VVDialog (VV hotkey) covers 15 model categories and 14 annotation categories with per-category visibility, separate projection/cut color/line weight/pattern overrides, and halftone toggle wired through to hiddenSemanticKinds. Missing: full ~120-category Revit catalogue and transparency slider |
...
| F-029 | View Templates                                       | Levels & Views | 🟡            | view_template elements in ProjectBrowser; create/duplicate/delete/apply plus Save as Template from the plan-view inspector; missing default template association per view type and full Revit Edit Type locking matrix |
...
| F-032 | Project Browser view organization by Discipline      | Levels & Views | 🟡            | Project Browser groups floor plans by discipline and subdiscipline when tags are set; missing full Revit Discipline → Subdiscipline → Type → Phase hierarchy |
...
| F-118 | Parametric kitchen slab family                       | Furn. Place   | ✅            | Composite kitchen slab asset seeded in residential template with width/depth/height plus sink/fridge offset parameters; plan/3D renderer shows embedded sink and fridge symbols |
| F-119 | Parametric bathroom layout family                    | Furn. Place   | ✅            | Compact bathroom layout asset seeded in residential template with toilet/vanity/shower offsets; plan/3D renderer shows the fixture layout as one movable/rotatable placed asset |
