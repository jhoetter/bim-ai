...
- Evidence requirements:
  ...
  - `git diff --check`.
- Evidence 2026-05-16:
  - Core geometry/lifecycle helper tests: `roofByFootprint.test.ts` (16), `structuralValidation.test.ts` (17), `modifyAvailability.test.ts` (17), `commandCapabilities.test.ts` (20), `wallConnectivity.test.ts` (11), `advisorStructuralViolations.test.ts` (6), `joinGeometry.test.ts`, `moveTool.test.ts`, `rotateTool.test.ts`, `wallOffsetTool.test.ts`, `arrayTool.test.ts`, `pinUnpin.test.ts`, `createSimilar.test.ts` — all pass.
