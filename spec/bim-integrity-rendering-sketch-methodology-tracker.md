...
| `BIR-H02` | `claude-skills/sketch-to-bim/sketch_bim.py`; `claude-skills/sketch-to-bim/tools.json`; `spec/sketch-to-bim-product-surfaces.md` | `packages/cli/sketchSkillHelper.smoke.test.mjs`; `pnpm --filter @bim-ai/cli exec node --test sketchSkillHelper.smoke.test.mjs`                                                                                         | `agent-loop-packet.json` (`sketch-to-bim.agent-loop-packet.v1`) links Advisor/constructability findings to element ids, source commands, command-log transactions, line hits, and next actions. | Wave 13-E local commit                                            | Skill-local adapter surface; product API/MCP descriptor remains follow-up, so status stays Partial.                                                                                |
