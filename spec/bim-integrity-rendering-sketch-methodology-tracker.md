...
| `BIR-N11` | P1       | Partial | Add live browser responsiveness acceptance.           | Deterministic target-house responsiveness evidence now covers orbit, selection, lens switching, and Advisor opening budgets in the final-package manifest. A real live dev-server/browser run for orbit, selection, Advisor open/close, and WebSocket reconnect behavior is still required before this can be marked Done.                                                                                                                                                                                          |
