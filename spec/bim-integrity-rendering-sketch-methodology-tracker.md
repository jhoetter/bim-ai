...
| `BIR-V04` | P1       | Partial     | Validate asset placement.               | Placed assets now validate declared wall/ceiling/workplane support, floor-footprint support for freestanding/floor assets, floating placement, and wall embedding without explicit intent. Remaining: richer oriented extents/recess geometry checks.                         |
...
| `BIR-V04` | `app/bim_ai/model_integrity.py`; `app/bim_ai/elements.py`; `app/bim_ai/commands.py`                                    | `PYTEST_ADDOPTS=--no-cov python -m pytest app/tests/test_model_integrity_invariants.py -q`                                                                                                                           | `model_integrity_asset_placement_support_invalid`; `model_integrity_asset_placement_floating`; `model_integrity_asset_placement_embedded_without_intent`                                      | Wave 15 Worker E local commit                                     | Partial: support/floating/embed checks are deterministic for declared supports; oriented footprint/recess geometry needs deeper asset geometry data.                                |
