...
| `BIR-P01` | `app/bim_ai/model_integrity.py`                                                                                        | `pytest app/tests/test_model_integrity_invariants.py --no-cov`                                                                                                                                                        | `modelIntegrityInvariantContract_v1` role, nested-reference, and level/storey contract fields                                                                                                  | Wave 15 Worker A local commit                                     | Partial: deterministic contract data is richer and machine-readable; generated standalone rule ledger remains follow-up.                                                           |
...
| `BIR-P08` | `app/bim_ai/model_integrity.py`                                                                                        | `pytest app/tests/test_model_integrity_invariants.py --no-cov`                                                                                                                                                        | `modelIntegritySmokeCommandEvidence_v1` with strict-role smoke and coverage metadata                                                                                                           | Wave 15 Worker A local commit                                     | Partial: helper is machine-readable for UI/API/CLI/MCP consumers; dedicated public CLI/REST/MCP endpoint wiring remains follow-up.                                                 |
