...
| `BIR-B07` | `app/bim_ai/model_integrity_hosting.py`; `packages/web/src/advisor/advisorViolationContext.ts`                         | `app/tests/test_model_integrity_hosting.py`; `packages/web/src/viewport/collectRendererDiagnostics.test.ts`                                                                                                           | Hosted-opening findings now include safe existing-command quick fixes for helper/proxy deletion and span resizing.                                                                              | Wave 14-B local commit                                           | Hints are limited to existing safe commands; rehost and support-creation commands remain future work.                                                                               |
