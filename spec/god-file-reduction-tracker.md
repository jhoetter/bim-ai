...
| GFR-2026-12 | P0       | Partial | `packages/web/src/plan/PlanCanvas.tsx`                      | Continue extracting presentational overlays and controllers        | PlanCanvas below `8,000` LOC with plan tests passing.       |
