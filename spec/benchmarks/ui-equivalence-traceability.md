...
| UI-equivalent path                 | todo              | `spec/benchmarks/simple-single-storey-house/expected-semantics.json`     | Needs UI/Cmd+K authoring automation and semantic diff before parity can be claimed. |
