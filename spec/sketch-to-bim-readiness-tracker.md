...
| `M3` Evidence and acceptance hardening          | Partial     | Advisor/constructability evidence collection, finding dispositions, visual evidence contract, BIM data checks, export validation, and live-golden baseline contracts are active. Current-head live screenshots, semantic visual evaluation, and stale checks remain generation-phase acceptance work. |
