...
| 2 | 2026-05-24 ~12:10Z | (all) | iter-2 author w/ NS-V3-05 dormer inward shift + NS-V3-06 L-shape roof rectify + NS-V3-03 balcony wiring landed. alpha +4 dormers +2 stairs +1 roof; beta +2 roofs +1 balcony; gamma +6 dormers +3 balconies. Honest grades: alpha 2.25 / beta 2.55 / gamma 2.90 — dormers still small / barely visible | mixed | NS-V3-07 bigger dormers + NS-V3-08 view cleanup |
| 3 | 2026-05-24 12:38Z | (all) | NS-V3-07 (dormer defaults 3500×2200×1500) + NS-V3-08 (per-floor ortho-viewpoint phase disabled) shipped. iter-3 ran but **idempotent filter blocked all dormer/roof cmds** — existing iter-2 IDs skipped → only 12 new viewpoints across all houses. Captures unchanged from iter-2 | n/a | NS-V3-09 force-rebuild + iter-4 |
| 4 | 2026-05-24 12:48Z | (all) | NS-V3-09 force-rebuild override: BIM_AI_FORCE_REBUILD_TYPES env var lists cmd types whose existing-id matches get deleteElement-prepended instead of skipped. iter-4 kicked off with createDormer,createRoof force-rebuild so NS-V3-07 sizing actually lands | running | wait + grade |
| 4.g | 2026-05-24 12:55Z | (all) | iter-4 honest grades: **alpha 1.80** (-0.45 vs iter-2 2.25), **beta 2.45** (-0.10), **gamma 2.35** (-0.55). All three regressed. Force-rebuild authored bigger dormers but they STILL don't render visibly. Eye-test confirms: alpha south capture shows blank red gable roof with no dormer bumps despite 4 dormers in snapshot. **Strategic pivot**: author throughput exhausted as a lever — engine MF-22 (dormer mesh) + MF-21 (gable opening cut) + render pipeline for terrain heightSamples are the actual gates | **1.80 / 2.45 / 2.35** | RENDER-AUDIT iter-5 |
