...
- `spec/methodology/sketch-to-bim-product-surfaces.md` for the current product/agent
  surface inventory.
...
- Phase packets must classify unresolved issues with the taxonomy in
  `spec/methodology/sketch-to-bim-failure-taxonomy.md`, including blocker/tolerance status,
