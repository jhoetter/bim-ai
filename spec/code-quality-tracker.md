...
| CQ-03 | `partial` | `workspace/agent/`, `workspace/bcf/`, `workspace/evidence/`, `workspace/inspector/`, `workspace/comments/`, `workspace/shell/`, `workspace/readouts/`, `workspace/sheets/`, and `workspace/project/` own their feature clusters; the root workspace directory is down from 164 to 55 files. |
