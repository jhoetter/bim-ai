...
| CQ-03 | `partial` | `workspace/agent/`, `workspace/bcf/`, and `workspace/evidence/` own their feature clusters; the root workspace directory is down from 164 to 136 files.                                      |
