...
| CQ-03 | `partial` | `workspace/agent/`, `workspace/bcf/`, `workspace/evidence/`, `workspace/inspector/`, `workspace/comments/`, `workspace/shell/`, `workspace/readouts/`, `workspace/sheets/`, `workspace/project/`, `workspace/authoring/`, and `workspace/library/` own their feature clusters; the root workspace directory is down from 164 to 29 files. |
