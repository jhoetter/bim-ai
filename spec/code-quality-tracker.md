...
| ----------------------------------------------------------- | ---------- | ------------------------------------------------------------------------------------------------- |
| `packages/web/src/plan/PlanCanvas.tsx`                      | 6,206      | High-churn plan interaction monolith after extracted overlay/state/lifecycle/render-pass modules. |
...
| `packages/web/src/workspace/inspector/InspectorContent.tsx` | 5.5k       | Inspector rendering and editing monolith after extracted type/monitor helper sections.            |
