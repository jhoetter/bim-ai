...
| UX-PRI-015 | Level edit controls              | Level stack                                | Secondary/element sidebar      | Partial  | Level controls are removed from primary and active level lives in secondary/status; selected datum sidebar parity still needs a dedicated row |
| UX-PRI-016 | Types browser                    | Primary rail browser                       | Project resources dialog       | Partial  | Types are removed from primary; broader project resource/type manager remains tracked                                                         |
