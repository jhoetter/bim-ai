...
| UX-LIVE-002 | `make seed name=target-house-3` loaded successfully, but UI label showed `Seed Library / target-house-1`.          | Project selector                  | Audit     | Verify project/seed naming before using screenshots as stakeholder evidence.              |
