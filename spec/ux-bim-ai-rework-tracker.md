...
| UX-R-006 | Load Family                                                                                                                                                | Ribbon Insert                    | Ribbon Insert                              | Partial | Correct authoring resource entry                                           | Keep in plan/concept/3D ribbons where placement/loading is meaningful         |
...
Evidence (2026-05-12): seeded live capture at `packages/web/tmp/ux-ribbon-per-view-20260512/` confirms task-based plan tabs (`Create/Sketch/Insert/Annotate/Review`) and scoped per-view ribbons for 3D (`3D View/Review`), sheet (`Sheet`), and schedule (`Schedule`).
