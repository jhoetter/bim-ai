...
- tracker rows: `20/20` done in `spec/archive/code-quality-tracker.md`
...
- 2026-05-20: `GFR-2026-43` is Done. The slice moved sheet, schedule, section,
  ...
  `pnpm --filter @bim-ai/web typecheck` passes.
- 2026-05-20: `GFR-2026-44` is Done. The slice moved saved-3D overlay view
  list derivation and direct-3D authoring work-plane controls into
...
- 2026-05-20: `GFR-2026-63` is Done. The slice moved site/toposolid,
  output/presentation, and MEP command schemas into `app/bim_ai/commands_site.py`,
  `app/bim_ai/commands_output.py`, and `app/bim_ai/commands_mep.py`, while
  preserving the legacy `bim_ai.commands` import surface. Local `wc -l`
...
- 2026-05-20: `GFR-2026-64` is Done. The slice moved Project Browser family
  ...
  `3,545` lines and the new modules at `239` and `211` lines. Focused
...
- 2026-05-20: `GFR-2026-65` is Done. The slice moved pipe, duct, cable tray,
  equipment, fixture, terminal, opening-request, and MEP legend element models
  into `app/bim_ai/elements_mep.py`, while preserving the legacy
  `bim_ai.elements` import surface and discriminated union membership. Local
  `wc -l` reports `app/bim_ai/elements.py` at `3,714` lines and the new MEP
  module at `280` lines. Python compile, ruff, and focused MEP/schema tests
  pass (`45 passed`).
- 2026-05-20: `GFR-2026-66` is Done. The slice moved balcony mesh rendering
