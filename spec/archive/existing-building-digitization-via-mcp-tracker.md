...
Archived because four newer trackers fully supersede this one and the repo inventory below is no longer the source of truth:

- `spec/reverse-bim-actual-methodology-tracker.md` — post-Leo-failure acceptance principles.
- `spec/reverse-bim-folder-output-methodology-tracker.md` — folder-output handoff contract.
- `spec/hybrid-reverse-bim-methodology-tracker.md` — active controlling methodology with GPF-001..013 items (~62% landed).
- `spec/testhouse-hybrid-reverse-bim-tracker.md` — live execution against three testhouses (iter-2 shipped 2026-05-22).

The inventory below remains valid as a 2026-05-20 snapshot; use it only to understand the historical state of REST descriptors, MCP coverage, and folder-output handoff at the point of supersession.
