...
This active audit tracker supersedes the archived audit file at
...
1. Active preflight paths and tool defaults.
2. CLI/API/MCP productization of sketch initiation.
