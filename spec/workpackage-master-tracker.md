...
| ID     | Item                                              | Effort | State                                                                                                                                                                                                                                                                                                                                                              | Depends on |
| ------ | ------------------------------------------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- |
| SKT-01 | `SketchSession` state machine + canvas mode       | XL     | `partial` in wave3-4 — floor (wave2-3) + roof + room_separation slices shipped (Finish dispatches to `createFloor` / `createRoof` / one `createRoomSeparation` per line); validation differentiated by element kind (closed-loop required for floor/roof, line-set required for room_separation); ceiling / in_place_mass / void_cut / detail_region deferred (ceiling waits on a `CeilingElem` + `createCeiling` kernel WP)                                                                                                                                                                                                                                                                                                                                  | —          |
