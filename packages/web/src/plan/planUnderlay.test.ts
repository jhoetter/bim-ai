...
type PlanViewFixture = { kind: 'plan_view'; id: string; showUnderlay?: boolean };
type WallFixture = { kind: 'wall'; id: string; levelId: string };
...
describe('Plan underlay — §2.9.4', () => {
  ...
  it('toggle flips showUnderlay', () => {
    const view: PlanViewFixture = { kind: 'plan_view', id: 'pv1', showUnderlay: false };
  ...
  it('underlay renders for walls on underlayLevelId', () => {
    const wall: WallFixture = { kind: 'wall', id: 'w1', levelId: 'l0' };
