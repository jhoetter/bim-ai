...
/**
 * Schedule mode shell — spec §20.6.
 *
 * Extracted from `ModeShells.tsx` in FE-CQ-02 so the schedule grid surface
 * (which transitively pulls in the schedule registry, presets, and floor-area
 * report code) can be lazy-loaded from `CanvasMount` instead of shipping in
 * the eager workspace chunk.
 */
