...
const MASS_CAPABILITIES: CommandCapability[] = [
  ...
  },
  {
    ...
    status: 'implemented',
    usabilityScore: 8,
    notes: '§6.4.2: places a detail_line polyline element in the active plan view.',
  },
  {
    ...
    status: 'implemented',
    usabilityScore: 8,
    notes: '§6.4.2: places a detail_filled_region polygon element in the active plan view.',
  },
];
