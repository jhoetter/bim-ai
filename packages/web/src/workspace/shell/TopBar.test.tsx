...
describe('RibbonBar — F-005', () => {
  ...
  it('uses a 3D ribbon schema with direct wall drafting and active 3D view controls', () => {
    ...
    expect(getByTestId('ribbon-command-shaft')).toBeTruthy();
    expect(getByTestId('ribbon-command-stair')).toBeTruthy();
    expect(getByTestId('ribbon-command-railing')).toBeTruthy();
    expect(queryByTestId('ribbon-bridge-wall')).toBeNull();
    expect(queryByTestId('ribbon-bridge-door')).toBeNull();
    expect(queryByTestId('ribbon-bridge-window')).toBeNull();
    expect(queryByTestId('ribbon-bridge-floor')).toBeNull();
    expect(queryByTestId('ribbon-bridge-roof')).toBeNull();
    expect(queryByTestId('ribbon-bridge-wall-opening')).toBeNull();
    expect(queryByTestId('ribbon-bridge-shaft')).toBeNull();
    expect(queryByTestId('ribbon-bridge-stair')).toBeNull();
    expect(queryByTestId('ribbon-bridge-railing')).toBeNull();
    expect(queryByTestId('ribbon-bridge-column')).toBeNull();
    expect(queryByTestId('ribbon-bridge-beam')).toBeNull();
    expect(queryByTestId('ribbon-bridge-ceiling')).toBeNull();
