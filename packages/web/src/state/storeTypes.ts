...
export type StoreState = {
  ...
  beamSystemSpacingMm: number;
  beamSystemDirectionDeg: number;
  activeWallTypeId: string | null;
  activeFloorTypeId: string | null;
  columnAtGridsSelectedIds: string[];
  columnDrawHeightMm: number;
  columnDrawWidthMm: number;
  columnDrawDepthMm: number;
  stairDrawBaseLevelId: string | null;
  stairDrawTopLevelId: string | null;
  stairDrawWidthMm: number;
  stairDrawRunWidthMm: number;
  roomDrawName: string;
  roomDrawNumber: string;
  roomDrawUpperLevelId: string | null;
  ...
  setFloorDrawOffsetMm: (mm: number) => void;
  ...
  setColumnDrawHeightMm: (mm: number) => void;
  setColumnDrawWidthMm: (mm: number) => void;
  setColumnDrawDepthMm: (mm: number) => void;
  setStairDrawBaseLevelId: (id: string | null) => void;
  setStairDrawTopLevelId: (id: string | null) => void;
  setStairDrawWidthMm: (mm: number) => void;
  setStairDrawRunWidthMm: (mm: number) => void;
  setRoomDrawName: (name: string) => void;
  setRoomDrawNumber: (num: string) => void;
  setRoomDrawUpperLevelId: (id: string | null) => void;
