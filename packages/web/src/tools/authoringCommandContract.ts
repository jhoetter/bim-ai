...
export const AUTHORING_COMMAND_CONTRACTS = {
  ...
  'stair-run': contract(
    ...
    'line',
    ['plan'],
    'Two-click start/end points define a stair run segment. §8.6.2',
    'select-after-commit',
    [],
    ['cancel'],
  ),
  'stair-landing': contract(
    'stair-landing',
    'sketch',
    ['plan'],
    'Sketch a polygon landing (≥3 pts + Enter). §8.6.2',
    'select-after-commit',
    [],
    ['finish', 'cancel'],
  ),
  ...
  'measure-angle': contract(
    'measure-angle',
    'review',
    ['plan'],
    '3-click angle measurement: vertex + two ray endpoints.',
    'stay-active',
    [],
    ['snap'],
  ),
  'measure-arc': contract(
    'measure-arc',
    'review',
    ['plan'],
    '3-click arc measurement: start + end + pass-through point.',
    'stay-active',
    [],
    ['snap'],
  ),
  ...
  'detail-line': contract(
    ...
    'sketch',
    ['plan'],
    'Draw 2D detail line polyline (≥2 pts + Enter to commit). §6.4.2',
    'select-after-commit',
    [],
    ['finish', 'cancel'],
  ),
  'detail-filled-region': contract(
    'detail-filled-region',
    'sketch',
    ['plan'],
    'Sketch 2D filled region polygon (≥3 pts + Enter to commit). §6.4.2',
    'select-after-commit',
    [],
    ['finish', 'cancel'],
  ),
