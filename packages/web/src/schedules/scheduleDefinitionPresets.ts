...
const PRESETS: ScheduleDefinitionPreset[] = [
  ...
  },
  {
    ...
    category: 'door',
    fields: [
      { fieldKey: 'mark', token: 'required', csvExportHint: 'Sequential door mark' },
      { fieldKey: 'typeId', token: 'required', csvExportHint: 'Door type id' },
      { fieldKey: 'widthMm', token: 'required', unitHint: 'mm' },
      { fieldKey: 'heightMm', token: 'required', unitHint: 'mm' },
      { fieldKey: 'level', token: 'required' },
      { fieldKey: 'count', token: 'required', aggregation: 'sum' },
    ],
  },
  {
    id: 'windows',
    ...
    category: 'window',
    fields: [
      { fieldKey: 'mark', token: 'required', csvExportHint: 'Sequential window mark' },
      { fieldKey: 'typeId', token: 'required', csvExportHint: 'Window type id' },
      { fieldKey: 'widthMm', token: 'required', unitHint: 'mm' },
      { fieldKey: 'heightMm', token: 'required', unitHint: 'mm' },
      { fieldKey: 'sillHeightMm', token: 'required', unitHint: 'mm' },
      { fieldKey: 'level', token: 'required' },
      { fieldKey: 'count', token: 'required', aggregation: 'sum' },
    ],
  },
  {
    ...
    category: 'column',
    fields: [
      { fieldKey: 'mark', token: 'required', csvExportHint: 'Sequential column mark' },
      { fieldKey: 'typeId', token: 'required', csvExportHint: 'Column type id' },
      { fieldKey: 'widthMm', token: 'required', unitHint: 'mm' },
      { fieldKey: 'depthMm', token: 'required', unitHint: 'mm' },
      { fieldKey: 'heightMm', token: 'required', unitHint: 'mm' },
      { fieldKey: 'level', token: 'required' },
      { fieldKey: 'count', token: 'required', aggregation: 'sum' },
    ],
